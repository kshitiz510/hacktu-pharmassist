...
def generate_report(prompt_id: str, background_tasks: BackgroundTasks, db: DatabaseManager = Depends(get_db)):
...
def list_available_reports(session_id: str = None):
    """
...
def test_report_generation(prompt_id: str):
    """
