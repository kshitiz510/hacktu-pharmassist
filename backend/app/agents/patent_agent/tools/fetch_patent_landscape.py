...
DATA_FILE = Path(DATA_DIR) / "patent_data.json"
...
def fetch_patent_landscape(drug_name: str, indication: str = None) -> dict:
    ...
    try:
        ...
        return {"error": "Patent data file not found", "drug_name": drug_name}
    except json.JSONDecodeError:
        return {"error": "Failed to parse patent data", "drug_name": drug_name}
