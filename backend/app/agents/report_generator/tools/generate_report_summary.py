...
DATA_FILE = Path(DATA_DIR) / "report_data.json"
...
def generate_report_summary(drug_name: str, indication: str = None) -> dict:
    ...
    try:
        ...
        return {"error": "Report data file not found", "drug_name": drug_name}
    except json.JSONDecodeError:
        return {"error": "Failed to parse report data", "drug_name": drug_name}
