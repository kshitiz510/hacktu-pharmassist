...
`from clinical_trials_api.ctgov_client import ClinicalTrialsGovClient`
"""
...
class ClinicalTrialsGovClient:
    ...
    def _normalize_study(self, study: Dict[str, Any]) -> Dict[str, Any]:
        ...
        normalized = {
            ...
            "study_first_post_date": self._extract_date(status.get("studyFirstPostDateStruct")),
            "results_first_post_date": self._extract_date(status.get("resultsFirstPostDateStruct")),
            "last_update_post_date": self._extract_date(status.get("lastUpdatePostDateStruct")),
    ...
    def _extract_outcomes(self, outcomes: Iterable[Dict[str, Any]]) -> List[Dict[str, Any]]:
        return [
            {
    ...
    def _extract_interventions(self, interventions: Iterable[Dict[str, Any]]) -> List[Dict[str, Any]]:
        return [
            {
    ...
    def _extract_arm_groups(self, arm_groups: Iterable[Dict[str, Any]]) -> List[Dict[str, Any]]:
        return [
            {
                "label": arm.get("label"),
                "type": arm.get("type"),
    ...
    def _extract_locations(self, locations: Iterable[Dict[str, Any]]) -> List[Dict[str, Any]]:
        return [
            {
    ...
    def _summarize_trials(self, trials: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "enrollment": {
                ...
                "total_enrollment": sum(enrollment_counts) if enrollment_counts else None,
                "median_enrollment": self._median(enrollment_counts) if enrollment_counts else None,
            },
        }
...
__all__ = ["ClinicalTrialsGovClient", "SUMMARY_FIELDS", "RESULT_FIELDS", "DEFAULT_BASE_URL"]
