...
# Add backend path
sys.path.insert(0, '/Users/guranshchugh/Desktop/PROJECTS/Pharmassist/pharmassist/backend')
...
if result4.get("status") == "error":
    ...
    if result4.get("supply_chain_resilience"):
        print(f"   Resilience score: {result4['supply_chain_resilience'].get('resilience_score')}")
        print(f"   Overall risk: {result4['import_risk_assessment'].get('overall_risk_level')}")
